...
function Bot(options) {
  ...
  this.slackChannelMute = options.slackChannelMute || {};
  this.ircChannelMute = options.ircChannelMute || {};
...
Bot.prototype.sendToIRC = function(message) {
  ...
  if (this.ircChannelMute.hasOwnProperty(ircChannel) &&
      this.ircChannelMute[ircChannel] === true) {
    logger.debug('IRC channel "', ircChannel, '" is muted.');
    return;
  }
...
Bot.prototype.sendToSlack = function(author, channel, text) {
  ...
  if (slackChannelName) {
    ...
    if (this.slackChannelMute.hasOwnProperty(slackChannelName) &&
        this.slackChannelMute[slackChannelName] === true) {
      logger.debug('Slack channel "', slackChannelName, '" is muted.');
      return;
    }
